...
```
Follow `.codex/commands/review-brief.md` with an audience and optional period
```

Examples:
- `manager "Q3 2024 + Q4 2024"`
- `peers "Q3 2024 + Q4 2024"`

## Playbook

- **`review-prep`** — aggregates all evidence (brag doc, decisions, incidents, competencies, 1:1 feedback, PR scans) for the period

Use the `review-prep` playbook first to gather raw material, then use its output to write the brief.
