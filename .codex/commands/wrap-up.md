...
```
Ask Codex to follow `.codex/commands/wrap-up.md`
```

Use this playbook when the user says "wrap up", "let's wrap", "wrapping up", or similar.

## Playbook

- **`brag-spotter`** — run at the end to find uncaptured wins and competency gaps from the session when deeper analysis is useful
...
- An `AGENTS.md` update needed (new convention, stale reference)?
- A new or improved playbook?
- A helper script that should be added or improved?
