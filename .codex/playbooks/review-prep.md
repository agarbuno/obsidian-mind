---
name: review-prep
description: "Aggregate performance review material from the vault for a given period. Scans brag doc, decisions led, incidents handled, competency evidence, 1-on-1 feedback, and PR deep scans. Invoke from the review-brief workflow or when the user asks for review prep."
